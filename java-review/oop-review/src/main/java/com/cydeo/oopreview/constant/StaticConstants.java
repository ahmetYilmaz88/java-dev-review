package com.ahmetyilmaz.oopreview.constant;
...
public class StaticConstants {
    public static final Long ahmetyilmaz_PARTNER_ID = 1L;
    ...
    public static final List<Payment> ahmetyilmaz_PAYMENT_LIST = new ArrayList<>();
